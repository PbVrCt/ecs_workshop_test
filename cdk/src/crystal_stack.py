...
class CrystalService(Stack):
    @property
    def mesh_crystal_virtual_service_arn(self):
        return self.mesh_crystal_vs.virtual_service_arn

    @property
    def mesh_crystal_virtual_service_name(self):
        ...
        **kwargs
        ...
        self.container = self.fargate_task_def.add_container(
            ...
            image=aws_ecs.ContainerImage.from_registry(
                "public.ecr.aws/aws-containers/ecsdemo-crystal"
            ),
        ...
        self.container.add_port_mappings(aws_ecs.PortMapping(container_port=3000))
        ...
        self.fargate_service = aws_ecs.FargateService(
            ...
            cloud_map_options=aws_ecs.CloudMapOptions(
                cloud_map_namespace=service_discovery_namespace, name="ecsdemo-crystal"
            ),
        )
