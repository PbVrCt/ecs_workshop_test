...
class BaseVPCStack(Stack):
    # These properties were retrieved inside the BasePlatform construct in the original workshop repos
    ...
    @property
    def services_security_group(self):
        return self.services_3000_sec_group

    @property
    def service_discovery_namespace(self):
        return self.sd_namespace

    # The properties below are the CfnOutputs from the original workshop repos

    @property
    def namespace_arn(self):
        return self.namespace_outputs["ARN"]

    @property
    def namespace_id(self):
        return self.namespace_outputs["ID"]

    @property
    def services_security_group_id(self):
        return self.services_3000_sec_group.security_group_id

    @property
    def ecs_cluster_name(self):
        return self.cluster_outputs["NAME"]

    @property
    def ecs_cluster_security_group(self):
        return self.cluster_outputs["SECGRPS"]

    @property
    def services_securtiy_group_id(self):
        return self.services_3000_sec_group.security_group_id

    @property
    def stress_tool_ec2_id(self):
        return self.instance.instance_id

    @property
    def stress_tool_ec2_ip(self):
        return self.instance.instance_private_ip

    # @property
    # def mesh_gateway_network_load_balancer_dns_name(self):
    #     return (
    #         self.mesh_gateway_proxy_fargate_service.load_balancer.load_balancer_dns_name
    #     )

    # @property
    # def mesh_arn(self):
    #     return self.mesh.mesh_arn

    # @property
    # def mesh_name(self):
    #     return self.mesh.mesh_name

    # @property
    # def mesh_envoy_service_arn(self):
    #     return self.mesh_gateway_proxy_fargate_service.service.service_arn

    # @property
    # def mesh_virtual_gateway_arn(self):
    #     return self.mesh_vgw.virtual_gateway_arn

    # @property
    # def mesh_virtual_gateway_name(self):
    #     return self.mesh_vgw.virtual_gateway_name
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        self.sd_namespace = (
            servicediscovery.PrivateDnsNamespace.from_private_dns_namespace_attributes(
                self,
                "SDNamespace",
                namespace_name=self.cluster_outputs["NAME"],
                namespace_arn=self.namespace_outputs["ARN"],
                namespace_id=self.namespace_outputs["ID"],
            )
        )
        ...
        with open("src/stresstool_user_data.sh") as f:
            user_data = f.read()
        ...
        self.instance = ec2.Instance(
            self,
            "Instance",
            instance_name="{}-stresstool".format(self.stack_name),
        ...
        #     "Mesh-VGW",
        #     mesh=self.mesh,
        #     listeners=[appmesh.VirtualGatewayListener.http(port=3000)],
        ...
        #         stream_prefix="/mesh-gateway", log_group=self.logGroup
        #     ),
        ...
        # self.mesh_gateway_proxy_fargate_service = (
